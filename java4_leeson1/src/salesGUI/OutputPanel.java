...
public class OutputPanel extends JPanel {
	...
	protected void writeOutput() {
		...
		String txtOutput = "<html>Sales Figures<br>__________________________<br>";
		...
		txtOutput += "<br>The total sales were: $ " + app.getTotalSales()
				+ "<br>";
	...
	protected String createSalesBarInfo(){
		...
		int overSalesBar = 0;
		int [] performance = app.determineTopSalesPeople();int [] sales = app.getSales();
		for (int x = 0; x < sales.length; x++)
		{
		if (performance[x] ==1)
		{
